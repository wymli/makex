...
var InitCmd = &cobra.Command{
	...
	Short:   "init creates the makex_config file in $HOME and makexfile in $pwd",
	Long: `init creates the makex_config file in $HOME and makexfile(makex.yaml) in $pwd, For example:
